...
export default async function WorkspaceAssistantPage() {
  ...
  return (
    <Container className="py-8 sm:py-10">
      <h1 className="text-2xl font-semibold text-foreground sm:text-3xl">Workspace assistant</h1>
      <p className="mt-2 max-w-2xl text-sm text-foreground-muted">
        Plan next steps across your tracked opportunities. Your private notes and checklist text are never sent to the
        assistant — only public deadline, funding, and eligibility data for opportunities you&apos;re already tracking.
      </p>
      ...
      <div className="mt-6 max-w-3xl">
        {available ? (
          ...
          <Alert tone="warning" title="The assistant is currently unavailable">
            You can still manage your workspace without it.
          </Alert>
        )}
      </div>
    </Container>
